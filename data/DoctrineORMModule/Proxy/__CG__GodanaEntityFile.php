 ...
 */
class File extends \Godana\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'url', 'name', 'size', 'title', 'description', 'images');
        }
    ...
    public function getImageUrlByDimension($dimension)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImageUrlByDimension', array($dimension));

        return parent::getImageUrlByDimension($dimension);
    }
